...
namespace SpacetimeDB.Types
{
	...
	public partial class MobileEntityComponent : IDatabaseTable
	{
		...
		[Newtonsoft.Json.JsonProperty("rotvalue")]
		public float Rotvalue;
		[Newtonsoft.Json.JsonProperty("move_start_timestamp")]
		public ulong MoveStartTimestamp;
		[Newtonsoft.Json.JsonProperty("rotate_start_timestamp")]
		public ulong RotateStartTimestamp;
		...
		public static SpacetimeDB.SATS.AlgebraicType GetAlgebraicType()
		{
			return SpacetimeDB.SATS.AlgebraicType.CreateProductType(new SpacetimeDB.SATS.ProductTypeElement[]
			{
				...
				new SpacetimeDB.SATS.ProductTypeElement("rotation", SpacetimeDB.Types.StdbQuaternion.GetAlgebraicType()),
				new SpacetimeDB.SATS.ProductTypeElement("rotvalue", SpacetimeDB.SATS.AlgebraicType.CreatePrimitiveType(SpacetimeDB.SATS.BuiltinType.Type.F32)),
				...
				new SpacetimeDB.SATS.ProductTypeElement("rotate_start_timestamp", SpacetimeDB.SATS.AlgebraicType.CreatePrimitiveType(SpacetimeDB.SATS.BuiltinType.Type.U64)),
			});
		}
		...
		public static explicit operator MobileEntityComponent(SpacetimeDB.SATS.AlgebraicValue value)
		{
			...
			return new MobileEntityComponent
			{
				...
				Rotation = (SpacetimeDB.Types.StdbQuaternion)(productValue.elements[3]),
				Rotvalue = productValue.elements[4].AsF32(),
				MoveStartTimestamp = productValue.elements[5].AsU64(),
				RotateStartTimestamp = productValue.elements[6].AsU64(),
			};
		}
		...
		public static System.Collections.Generic.IEnumerable<MobileEntityComponent> FilterByRotvalue(float value)
		{
			foreach(var entry in SpacetimeDBClient.clientDB.GetEntries("MobileEntityComponent"))
			{
		...
		public static System.Collections.Generic.IEnumerable<MobileEntityComponent> FilterByRotateStartTimestamp(ulong value)
		{
			foreach(var entry in SpacetimeDBClient.clientDB.GetEntries("MobileEntityComponent"))
			{
				var productValue = entry.Item1.AsProductValue();
				var compareValue = (ulong)productValue.elements[6].AsU64();
				if (compareValue == value) {
					yield return (MobileEntityComponent)entry.Item2;
				}
			}
